exports.run = function (client, msg, args, config, Discord) {
    ...
    const embed = new Discord.RichEmbed()
        ...
        .setDescription(`Prefix is \`${config.prefix[0]}\`.`)
        .addField('Example:', `${config.prefix[0]} shitpost`)
        .addField('Commands', `do \`${config.prefix[0]} commands\` to see a full list of commands.`)
