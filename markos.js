...
let bannedWords = ["banana", "potato"]


var cleverbot = require("cleverbot.io"),c
clever = new cleverbot("k20deqHC0qUyVnbi", "MWt1kdPbSHN1c2LR0TVyu4qmkhE40zOw");
...
//anti-bot line
    ...
    if (message.content.includes(bannedWords)[0]) {
        message.channel.sendMessage("You can't say that");
        message.delete()
    }
